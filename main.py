...
# ---  to  launch notepad for editing input.txt   ---
import subprocess

subprocess.run(["notepad.exe", "input.txt"], check=False)
print("Opening notepad to edit job description")
...
doc.save("AhmedElshabasiResume.docx")

import os

# open the file automatically (Windows only)
os.startfile("AhmedElshabasiResume.docx")
